...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      // Clases fixed, bottom y right para mantenerlo flotando en la esquina
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-2xl hover:-translate-y-1 hover:scale-110 transition-all duration-300 group"
      aria-label="Contactar por WhatsApp"
    >
      {/* SVG súper ligero del logo de WhatsApp */}
      <svg
        viewBox="0 0 24 24"
        width="28"
        height="28"
